...
public class LandscapeDisplay {
    ...
    public static void main(String[] args) throws InterruptedException {
        LifeSimulation life = new LifeSimulation(true);
        System.out.println("run sim");
        
        life.runSimulation(true); //uncomment this to run simulator with till the game end
        // life.runSimulation(200, true); //uncomment this to run simulator with 1000 frames and output each frame to file
    }
}